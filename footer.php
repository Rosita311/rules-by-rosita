<footer>
  <div class="footer-container">
    <div class="footer-content">
      ...
      $socials = [
        'facebook' => [
          'label' => 'Facebook',
          'url' => get_theme_mod('rulesbyrosita_facebook_url'),
        ...
        'instagram' => [
          'label' => 'Instagram',
          'url' => get_theme_mod('rulesbyrosita_instagram_url'),
        ...
        'linkedin' => [
          'label' => 'LinkedIn',
          'url' => get_theme_mod('rulesbyrosita_linkedin_url'),
        ...
        'mastodon' => [
          'label' => 'Mastodon',
          'url' => get_theme_mod('rulesbyrosita_mastodon_url'),
          'svg' => '<svg
        ...
        'github' => [
          'label' => 'GitHub',
          'url' => get_theme_mod('rulesbyrosita_github_url'),
        ...
        'wordpress' => [
          'label' => 'WordPress.com',
          'url' => get_theme_mod('rulesbyrosita_wordpress_url'),
        ...
        'pinterest' => [
          'label' => 'Pinterest',
          'url' => get_theme_mod('rulesbyrosita_pinterest_url'),
  ...
  <div class="footer-info">
    ...
    <p>&copy; <?php echo date('Y'); ?> Rules by Rosita</p>
  </div>
  </div>
</footer>
</body>
