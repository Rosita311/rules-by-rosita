<?php
define( 'RULES_BY_ROSITA_FONTS_URL', 'https://fonts.googleapis.com/css2?family=Atkinson+Hyperlegible+Next:wght@400;700&family=Nunito:wght@300;400;500;700&family=Zilla+Slab:wght@400;700&display=swap' );
