...
>
  <head>
    ...
    <meta
      name="description"
      content="Welkom op Rulesbyrosita.nl, mijn blog over inspiratie over het leven (met een beperking), mijn zoektocht naar de regels in het leven,persoonlijke ontwikkeling, en lifestyle. Have fun! Liefs Rosita"
    />
    <link
      rel="preconnect"
    ...
    />
    <link
      href="https://fonts.googleapis.com/css2?family=Atkinson+Hyperlegible:ital,wght@0,400;0,700;1,400;1,700&family=Nunito:ital,wght@0,200..1000;1,200..1000&family=Zilla+Slab&display=swap"
      rel="stylesheet"
    />
    <link
      rel="preload"
  ...
  <body>
    ...
    <header>
      <div class="header-container">
        ...
        >
          <img
            src="./assets/Logo_rulesbyrosita.png"
            class="site-logo"
            alt="Logo Rules by Rosita, Ga naar de homepage"
            loading="lazy"
            width="200"
            height="200"
          />
        ...
        <div class="menu-items">
          ...
          >
            <ul>
              ...
              <li><a href="archive.html">Persoonlijk(Archive)</a></li>
          ...
          <ul class="hero-listing">
            <li class="hero-card">
              <div class="hero-image-wrapper">
                <img
                  src="./assets/thought-catalog-SqAcgMAWIaM-unsplash.jpg"
                  alt=""
                  loading="lazy"
                  width="600"
                  height="400"
                ...
                <div class="hero-card-content hover-shadow">
                  <div class="post-info">
                    <h1 class="post-title h1">
                      <a
                        href="single.html"
                        aria-describedby="excerpt-1 lees-meer-1"
                        >Hoe ik mijn eigen WordPress-thema heb gebouwd</a
                      >
                    </h1>
        ...
        <section class="introduction">
            ...
            <div class="introduction-card-content entry-content">
              ...
              <ul class="introduction-iconlist">
                <li>
                  ...
                  <span
                    ><span class="introduction-label-text">Ik lees:</span>
                ...
                <li>
                  ...
                  <span
                    ><span class="introduction-label-text">Ik leer:</span>
                ...
                <li>
                  ...
                  <span
                    ><span class="introduction-label-text">Ik kijk:</span>
                    <a href="https://www.netflix.com/nl/title/70136137"
                      >Sex and the City</a
                    ></span
                  >
                </li>
          ...
          <div class="introduction-image-wrapper">
            <div class="introduction-image dotted-background-blue">
              <img
                src="./assets/alex-sheldon-0ncyUZzWqmQ-unsplash.jpg"
        ...
        <section class="blogpost-section">
          ...
          <ul class="blog-listing-grid">
            ...
            <li class="card hover-shadow">
              <div class="card-image">
                <img
                  src="./assets/ella-olsson-KPDbRyFOTnE-unsplash.jpg"
                  alt=""
                  loading="lazy"
                  width="600"
                  height="400"
            ...
            <li class="card hover-shadow">
              <div class="card-image">
                <img
                  src="./assets/daniele-levis-pelusi-jTknOGI18us-unsplash.jpg"
                  alt=""
                  loading="lazy"
                  width="600"
                  height="400"
          ...
          <div class="footer-social">
            <div class="footer-subscribe">
              ...
              >
                ...
                <p>
                  Dit formulier wordt vervangen door de Jetpack abonnementen.
                </p>
              </form>
            </div>
        ...
        <div class="footer-info">
          ...
          >
            ...
            <span
              id="plumbob-desc"
              class="sr-only"
              >Sims plumbob animatie zegt: Sul sul!</span
            >
            <span
